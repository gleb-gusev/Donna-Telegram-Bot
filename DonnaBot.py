...
def process_message(message):
    ...
    if (message.text == '/flashback'):
        ...
        answermarkup.add(markup.skipbtn)
        bot.send_message(message.chat.id, "I'm Donna Moss, I came here to volunteer and the woman assigned me to you.",
        ...
        answermarkup.add(markup.skipbtn)
        bot.send_message(message.chat.id, "I'm here because I want to work for Bartlet. I'm a college graduate, with a degree in Political Science and Government", reply_markup=answermarkup)
        ...
        answermarkup.add(markup.skipbtn)
        bot.send_message(message.chat.id, "Okay, when I said I graduated, I may have been overstating a little?", reply_markup=answermarkup)
        ...
        answermarkup.add(markup.skipbtn)
        bot.send_message(message.chat.id, "And biology for a while, with a minor in French?", reply_markup=answermarkup)
        ...
        bot.send_message(message.chat.id, "I think that question is of a personal nature?", reply_markup=answermarkup)
    ...
    elif message.text == ('And the idea was that you\'d drop out and pay the bills till he was done with his residency.'):
        ...
        answermarkup.add(markup.skipbtn)
        bot.send_message(message.chat.id, "What, is it going to interfere with my typing?", reply_markup=answermarkup)

    elif message.text == ('Donna, we\'re picking up today and going to South Carolina. If you want to stay in the Manchester office'):
        ...
        answermarkup.add(markup.skipbtn)
        bot.send_message(message.chat.id, "I'll sleep on the floor, I'll sell my car. Eventually, you're going to put me on salary.", reply_markup=answermarkup)

    elif message.text == ('Donna.'):
        answermarkup.add(markup.goaheadbtn)
        answermarkup.add(markup.skipbtn)
        bot.send_message(message.chat.id, "Look. I think I might be good at this. I think you might find me valuable.", reply_markup=answermarkup)
        ...
        # TODO Set Possible Options for Keyboard here
